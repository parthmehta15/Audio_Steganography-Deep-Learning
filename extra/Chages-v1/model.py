...
class Encoder(nn.Module):
    # def __init__(self, conv_dim=1, block_type='normal', n_layers=3):  #c
    def __init__(self, conv_dim=2, block_type='normal', n_layers=3):  #c
...
class CarrierDecoder(nn.Module):
    def __init__(self, conv_dim, block_type='normal', n_layers=4):
        ...
        layers.append(block(c_in=64, c_out=2, kernel_size=1, stride=1, padding=0, deconv=False))
...
class MsgDecoder(nn.Module):
    ...
    def __init__(self, conv_dim=2, block_type='normal'):
        ...
        self.main = nn.Sequential(
                ...
                block(c_in=64, c_out=2, kernel_size=3, stride=1, padding=1, deconv=False)
                )
